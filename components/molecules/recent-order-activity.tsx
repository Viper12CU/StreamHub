...
const events: ActivityEvent[] = [
  { icon: "cart", iconColor: "text-primary", iconBg: "bg-primary/20", text: "Orden ORD-2026-000482 creada por Alex Murphy", timestamp: "Hace 2 min", admin: "Sistema" },
  { icon: "check-circle", iconColor: "text-green-400", iconBg: "bg-green-400/20", text: "Pago aprobado - ORD-2026-000481 (Sarah Chen)", timestamp: "Hace 8 min", admin: "Admin Principal" },
  { icon: "package-variant", iconColor: "text-secondary", iconBg: "bg-secondary/20", text: "Cuenta Netflix asignada a ORD-2026-000478 (Marcus V.)", timestamp: "Hace 15 min", admin: "Admin Principal" },
  { icon: "truck", iconColor: "text-tertiary", iconBg: "bg-tertiary/20", text: "Orden ORD-2026-000477 entregada a Elena Kas", timestamp: "Hace 22 min", admin: "Sistema" },
