...
const alerts: Alert[] = [
  { icon: "clock-outline", text: "5 pagos pendientes > 24h", severity: "error", timestamp: "Hace 10 min", action: "Revisar" },
  { icon: "package-variant", text: "Disney+ sin stock (12 pausados)", severity: "error", timestamp: "Hace 25 min", action: "Gestionar" },
  { icon: "truck-delivery", text: "8 órdenes esperando entrega", severity: "warning", timestamp: "Hace 1h", action: "Ver" },
  { icon: "dns", text: "Latencia en Gateway EU", severity: "warning", timestamp: "Hace 2h", action: "Detalles" },
  { icon: "information", text: "Mantenimiento DB a las 02:00 AM", severity: "info", timestamp: "Hace 3h" },
]
