...
const actionConfig: Record<string, { icon: string; iconColor: string; iconBg: string }> = {
  "Cliente registrado": { icon: "person_add", iconColor: "text-primary", iconBg: "bg-primary/20" },
  "Orden creada": { icon: "shopping_cart", iconColor: "text-secondary", iconBg: "bg-secondary/20" },
  "Pago completado": { icon: "check_circle", iconColor: "text-green-400", iconBg: "bg-green-400/20" },
  "Activo asignado": { icon: "subscriptions", iconColor: "text-tertiary", iconBg: "bg-tertiary/20" },
}
